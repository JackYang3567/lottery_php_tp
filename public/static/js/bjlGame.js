...
! function() {
    function t(t) { return Object.prototype.toString.apply(t).toLowerCase().replace("[object ", "").replace("]", "") } window.utils = {
        datatype: t,
        generateArray: function(e, n) { for (var o = Array(e + 1).join("a").split(""), i = 0, e = o.length; i < e; i++) "function" === t(n) ? o[i] = n.apply(null, [o[i], i]) : o[i] = n || !1; return o },
        forEach: function(e, n, o) {
            var i, a, r = t(e),
                l = -1;
            if ("object" === r) {
                for (i in e)
                    if (e.hasOwnProperty(i) && (l++, "break" === n.apply(o, [e[i], i, l, e]))) break
            } else if ("array" === r)
                for (i = 0, a = e.length; i < a && "break" !== n.apply(o, [e[i], i, e]); i++);
        },
        map: function(e, n, o) {
            var i, a, r, l = t(e),
                s = -1;
            if ("object" === l) { r = {}; for (i in e) e.hasOwnProperty(i) && (s++, r[i] = n.apply(o, [e[i], i, s, e])) } else if ("array" === l)
                for (r = [], i = 0, a = e.length; i < a; i++) r[i] = n.apply(o, [e[i], i, e]);
            else r = e;
            return r
        },
...
function() {
    function t(t, e, n) { this.tagName = t, this.props = e || {}, this.children = n || [], this.key = e && e.key || void 0 } t.prototype.constructor = t, t.prototype.render = function() {
        ...
        for (var s, c = this.children, h = this.children.length, d = 0; d < h; d++)(s = c[d]) instanceof t ? e.appendChild(s.render()) : e.innerHTML = s;
        return e
    }, window.vnode = function(e, n, o) { return new t(e, n, o) }
}(),
function() {
    function t(t, e, n, o) {
        if ("wl0" !== n && "wl1" !== n && "wl2" !== n && "lz" !== n && "zx" !== n) throw new Error("wrong type!");
        this.init(t, e, n, o)
    }
    t.prototype.constructor = t, t.prototype.init = function(t, e, n, o) { this.elId = o, this.typeName = n, this.maxRowsLen = e, this.maxColumnsLen = { lz: 25, zx: 8, wl0: 20, wl1: 20, wl2: 20 }[n], this.winNameMapping = { zhuang: "庄", xian: "闲", he: "和" }, this.sourceData = [], this.groupedData = [], this.table = [], this.latestForecast = null, this.askRoadData = null, this.initSourceData(t || []) }, t.prototype.initSourceData = function(t) {
        var e = t.slice(0);
        e.sort(function(t, e) { return parseInt(t.IssueNo, 10) - parseInt(e.IssueNo, 10) });
        var n = e.pop();
        this.latestForecast = { issueNo: n.IssueNo, largeSmall: "Da" === n.DaXiao ? "large" : "small", isXianDui: n.IsXianDui, isXianWanMeiDui: n.IsXianWanMeiDui, isZhuangDui: n.IsZhuangDui, isZhuangWanMeiDui: n.IsZhuangWanMeiDui, zhuang: utils.map(n.ForeCast.split(""), function(t) { return +t }), xian: null }, this.latestForecast.xian = utils.map(this.latestForecast.zhuang, function(t) { return 1 === t ? 2 : 1 }), this.sourceData = utils.map(e, function(t) { return t = { issueNo: t.IssueNo, largeSmall: "Da" === t.DaXiao ? "large" : "small", isXianDui: t.IsXianDui, isXianWanMeiDui: t.IsXianWanMeiDui, isZhuangDui: t.IsZhuangDui, isZhuangWanMeiDui: t.IsZhuangWanMeiDui, xian: t.Xian, zhuang: t.Zhuang, forecast: t.ForeCast, win: t.Xian > t.Zhuang ? "xian" : t.Xian < t.Zhuang ? "zhuang" : "he" }, t.forecast = t.forecast && utils.map(t.forecast.split(""), function(e, n) { return "xian" === t.win ? "1" === e ? 2 : 1 : "zhuang" === t.win ? +e : 0 }) || [0, 0, 0], t })
    ...
    t.prototype.generateVNodes = function() {
        ...
        return utils.map(t.table.slice(-t.maxColumnsLen),

        function(n, o) {

          return vnode("div", { class: ["road-new-column", "road-new-column-" + t.typeName] },
          utils.map(n, function(n, o) {

            return vnode("div",

            { class: ["road-new-item", "road-new-item-" + t.typeName] }, !1 !== n ? [

              vnode("div", {
                class: [
                  "road-new-item-ball",
                  "road-new-item-ball-" + t.typeName, n.win || "",
                  n.hes ? "hes-" + n.hes.length : "",
                  n.isAskRoad ? "blink-ball" : "",
                  n.isZhuangDui ? "zhuang-dz" : "",
                  n.isZhuangWanMeiDui ? "zhuang-wmdz" : "",
                  n.isXianDui ? "xian-dz" : "",
                  n.isXianWanMeiDui ? "xian-wmdz" : ""
                ]
              }, [
                n.win && t.winNameMapping[n.win] || ""
              ].concat("lz" === t.typeName && n.hes && utils.map(
                n.hes, function(t, e) {
                  return vnode("div", { class: ["row-new-item-ball-he", "row-new-item-ball-he-" + e, n.win || ""] }, [""])
                }
              ) || [])
            )

            ].concat("zx" === t.typeName && vnode("div", { class: ["road-new-item-ls", n.largeSmall, n.isAskRoad ? "blink-ball" : ""] }, [e[n.largeSmall]]) || []) : ["&nbsp;"]
          )
    ...
    t.prototype.printHTML = function() {
        ...
        t.innerHTML = "";
        for (var n = 0, o = e.length; n < o; n++) t.appendChild(e[n].render())
    }, t.prototype.toggleToAskRoad = function(t, e) {
        var n = utils.copyObject(t);
        n.isAskRoad = !0, n.win = e, n.forecast = n[e] || [0, 0, 0], n.zhuang = 9, n.xian = 9, this.askRoadData ? this.askRoadData.win === e ? (this.sourceData.pop(), this.askRoadData = null) : (this.sourceData.pop(), this.askRoadData = utils.copyObject(n), this.sourceData.push(n)) : (this.askRoadData = utils.copyObject(n), this.sourceData.push(n)), this.draw()
    }, t.prototype.draw = function() { this.groupData(), this.generateTable(), this.printHTML() }, window.Chart = t
}(),
function() {
    function t(t, e, n) { this.init(t, e, "lz", n) }
    var e = function() {};
    e.prototype = Chart.prototype, (t.prototype = new e).constructor = t, t.prototype.init = function(t, n, o, i) { e.prototype.init.apply(this, arguments) }, t.prototype.groupData = function() {
        var t = [],
            e = this;
        utils.forEach(e.sourceData, function(e, n) { t.push(e.win + "#" + n) }), t = t.join(","), t = t.replace(/^(?:he#\d+)+,/, ""), t = t.replace(/(xian#\d+),zhuang/g, "$1:zhuang"), t = t.replace(/(xian#\d+(?:,he#\d+)+),zhuang/g, function(t, e) { return e + ":zhuang" }), t = t.replace(/(zhuang#\d+),xian/g, "$1:xian"), t = t.replace(/(zhuang#\d+(?:,he#\d+)+),xian/g, function(t, e) { return e + ":xian" }), t = t.split(":"), utils.forEach(t, function(n, o) {
            n = (n = (n = n.replace(/(he#\d+),(xian|zhuang)/g, "$1:$2")).replace(/(xian#\d+),(xian#\d+,he#)/g, "$1:$2")).replace(/(zhuang#\d+),(zhuang#\d+,he#)/g, "$1:$2");
            var i = [];
            utils.forEach(n.split(":"), function(t, n) {
                var o = /he#\d+/.test(t);
                if (t = t.split(","), o) {
                    var a = t.shift().replace(/.+#/, ""),
                        r = e.sourceData[a];
                    r.hes = utils.map(t, function(t) { var n = t.replace(/.+#/, ""); return e.sourceData[n] }), i.push(r)
                } else utils.forEach(t, function(t, n) { i.push(e.sourceData[t.replace(/.+#/, "")]) })
            }), t[o] = i
        }), this.groupedData = t
        ...
        function t(t) {
            var n = e[t],
                l = i || t;
            void 0 === a[l] && (a[l] = utils.generateArray(o, !1), r[l] = o);
            var s = r[l];
            if (n.length <= s) utils.forEach(n, function(t, e) { a[l][e] = t });
            else {
                var c = n.slice(0, s);
                ...
                utils.forEach(h, function(t, e) {
                    var n = l + e + 1;
                    void 0 === a[n] && (a[n] = utils.generateArray(o, !1)), r[n] = r[l], a[n][r[l] - 1] = t, r[n]--, h.length - 1 === e && 0 === r[n] && (i = n + 1)
                })
            }
        }
        var e = this.groupedData.slice(0),
            n = this.maxColumnsLen,
            o = this.maxRowsLen;
        e.length > n && (n = e.length);
        var i, a = utils.generateArray(n, function() { return utils.generateArray(o, !1) }),
            r = utils.map(a, function(t) { return o });
        utils.forEach(e, function(e, n) { t(n) }), this.table = a
    }, window.LZChart = t
}(),
function() {
    function t(t, e, n) { this.init(t, e, "zx", n) }
    var e = function() {};
    e.prototype = Chart.prototype, (t.prototype = new e).constructor = t, t.prototype.init = function(t, n, o, i) { e.prototype.init.apply(this, arguments) }, t.prototype.groupData = function() {
        for (var t = this.sourceData.slice(0), e = this.maxRowsLen, n = this.maxColumnsLen, o = []; t.length > e;) o.push(t.slice(0, e)), t.splice(0, e);
        o.push(t.concat(utils.generateArray(e - t.length, !1)));
        var i = o.length;
        i < n && (o = o.concat(utils.generateArray(n - i, function() { return utils.generateArray(e, !1) }))), this.groupedData = o
    }, t.prototype.generateTable = function() { this.table = this.groupedData.slice(0) }, window.ZXChart = t
}(),
function() {
    function t(t, e, n, o) {
        if ("wl0" !== n && "wl1" !== n && "wl2" !== n) throw new Error("wrong type!");
        this.init(t, e, n, o)
    }
    var e = function() {};
    e.prototype = LZChart.prototype, (t.prototype = new e).constructor = t, t.prototype.init = function(t, n, o, i) { e.prototype.init.apply(this, arguments), this.forecastIndex = { wl0: 0, wl1: 1, wl2: 2 }[this.typeName] }, t.prototype.groupData = function() {
        var t = [],
            e = this;
        utils.forEach(e.sourceData, function(n, o) { t.push(n.forecast[e.forecastIndex] + "#" + o) }), t = t.join(","), t = t.replace(/(0#\d+)+/g, "").replace(/,+/g, ",").replace(/^,|,$/g, ""), t = t.replace(/(1#\d+),2/g, function(t, e) { return e + ":2" }), t = t.replace(/(2#\d+),1/g, function(t, e) { return e + ":1" }), t = t.split(":"), utils.forEach(t, function(n, o) {
            var i = [];
            utils.forEach(n.split(","), function(t) { i.push(e.sourceData[t.replace(/.+#/, "")]) }), t[o] = i
        }), this.groupedData = t
    }, t.prototype.generateVNodes = function() { var t = this; return utils.map(t.table.slice(-t.maxColumnsLen), function(e, n) { return vnode("div", { class: ["road-new-column", "road-new-column-" + t.typeName] }, utils.map(e, function(e, n) { return vnode("div", { class: ["road-new-item", "road-new-item-" + t.typeName] }, !1 !== e ? [vnode("div", { class: ["road-new-item-ball", "road-new-item-ball-" + t.typeName, e.win || "", "color" + e.forecast[t.forecastIndex], e.isAskRoad ? "blink-ball" : ""] }, [e.win && t.winNameMapping[e.win] || ""])] : ["&nbsp;"]) })) }) }, t.prototype.printHTML = function(t) {
        function n(t) { i.push(vnode("div", { class: ["wl-item-container", t] }, [vnode("div", { class: ["wl-item", "wl-item-text", t] }, [o.winNameMapping[t]])].concat(utils.map(o.latestForecast[t], function(e, n) { return vnode("div", { class: ["wl-item", "wl" + n + "-" + t, "color" + e], "data-type": t, "data-color": "color" + e }, [""]) })))) } e.prototype.printHTML.apply(this, arguments);
        var o = this,
            i = [];
        n("zhuang"), n("xian");
...
function() {
    function t(t, e) { this.elId = e, this.zhuang = 0, this.xian = 0, this.he = 0, this.zhuangDui = 0, this.xianDui = 0, this.eightOrNinePoint = 0, this.totalNum = 0, this.init(t) } t.prototype.constructor = t, t.prototype.init = function(t) {
        var e = this,
            n = t.slice(0);
        n.sort(function(t, e) { return parseInt(t.IssueNo, 10) - parseInt(e.IssueNo, 10) }), n.pop(), e.totalNum = n.length, utils.forEach(n, function(t, n) { t.Xian > t.Zhuang ? e.xian++ : t.Xian < t.Zhuang ? e.zhuang++ : e.he++, t.IsXianDui && e.xianDui++, t.IsZhuangDui && e.zhuangDui++, (t.Xian >= 8 || t.Zhuang >= 8) && e.eightOrNinePoint++ })
    }, t.prototype.printHTML = function() {
        var t = [vnode("div", { class: ["road-new-counter-item", "zhuang"] }, ["庄：" + this.zhuang]), vnode("div", { class: ["road-new-counter-item", "xian"] }, ["闲：" + this.xian]), vnode("div", { class: ["road-new-counter-item", "he"] }, ["和：" + this.he]), vnode("div", { class: ["road-new-counter-item", "zhuang"] }, ["庄对：" + this.zhuangDui]), vnode("div", { class: ["road-new-counter-item", "xian"] }, ["闲对：" + this.xianDui]), vnode("div", { class: ["road-new-counter-item"] }, ["8/9点：" + this.eightOrNinePoint]), vnode("div", { class: ["road-new-counter-item"] }, ["局数：" + this.totalNum])],
            e = document.getElementById(this.elId);
        e.innerHTML = "", utils.forEach(t, function(t, n) { e.appendChild(t.render()) })
    }, window.ChartCounter = t
}(),
function() {
    function t() { this.charts = {} } t.prototype.constructor = t, t.prototype.entry = function(t) {
        var e = {};
        e.lz = new LZChart(t, 6, "road-new-table-1"), e.lz.draw(), e.zx = new ZXChart(t, 6, "road-new-table-2"), e.zx.draw(), e.wl0 = new WLChart(t, 6, "wl0", "road-new-table-3"), e.wl0.draw(), e.wl1 = new WLChart(t, 6, "wl1", "road-new-table-4"), e.wl1.draw(), e.wl2 = new WLChart(t, 6, "wl2", "road-new-table-5"), e.wl2.draw(), e.cc = new ChartCounter(t, "road-new-counter"), e.cc.printHTML(), this.charts = e
    }, t.prototype.askRoad = function(t) {
        var e = this.charts,
            n = e.wl0.latestForecast;
        e.lz.toggleToAskRoad(n, t), e.zx.toggleToAskRoad(n, t), e.wl0.toggleToAskRoad(n, t), e.wl1.toggleToAskRoad(n, t), e.wl2.toggleToAskRoad(n, t)
...
function() {
    ...
    function t(t, e, n) {
        var o = t[e];
        Object.defineProperty(t, e, { get: function() { return o }, set: function(e) { n.call(t, e, o), o = e } })
    }
    var e = { gameStatus: "" };
    $(function(n) {
        function o() {
            nt.mute(!0), ot.mute(!0), it.mute(!0), at.mute(!0), rt.mute(!0), lt.mute(!0), st.mute(!0), ct.mute(!0), ht.mute(!0), dt.mute(!0), ut.mute(!0), pt.mute(!0), ft.mute(!0), gt.mute(!0), mt.mute(!0), vt.mute(!0), yt.mute(!0), wt.mute(!0);
            for (t = 0; t < kt.length; t++) kt[t].mute(!0);
            for (var t = 0; t < xt.length; t++) xt[t].mute(!0);
            bt = !0, Ct.removeClass("opened")
        }

        function i(t) { var e = n(".desk"); "" === e.text() && e.text(t) }

        function a(t) { n("#issueNo").text(t + "期") }

        function r() { n.ajax({ url: "/home/lhd/realTimeData", type: "POST", dataType: "json", cache: !1, success: function(t) { void 0 !== t.B && n("#balance").text(t.B) } }) }

        function l() {
            n.ajax("/home/bjl/bjlodds", {
                type: "POST",
                dataType: "json",
                data: { Desk: Xt, type: 0 },
                cache: !1,
                success: function(t) {
                    var e;
                    t ? "object" === n.type(t) ? (n.each(t, function(t, o) { n(".bet").find("#" + t).length || (e = !0) }), e ? s(l, "not found desk") : n.each(t, function(t, e) {
                        var o = n(".bet").find("#" + t);
                        o.append(o.attr("data-text") + "<i>1<b>:</b>" + parseFloat(e) + "</i>")
                    })) : s(l, "odds has error") : s(l, "odds is undefined")
                }
            })
        }

        function s(t, e) { e && console.error(e); var n = setTimeout(function() { clearTimeout(n), t() }, 2e3) }

        function c() { Tt || (Tt = !0, d("很抱歉，该房间已关闭", function() { location.href = history.go(-1) })) }

        function h(t) { n.ajax("/home/Game/getInfo", { type: "POST", dataType: "json", cache: !1, data: { Desk: Xt, type: 0 }, success: function(e) { e ? (S = e, null !== e.Chip && !1 !== e.IsEnable ? (0 === e.Status ? M || (M = n('<div class="mask alert ab0 flex center middle close-msg">\n   <div>\n       <div>' + (e.CloseInfo || "此游戏正在维护中...") + "</div>\n   </div>\n</div>\n"), n("body").append(M), R.text("维护中")) : M && (M.remove(), M = null, R.text("确认下注")), i(e.DisplayName), a(e.IssueNo), m(e), f(e), t && b(e.State)) : c()) : n(".loading").length && s(h, "roomData is undefined") } }) }

        function d(t, e, o, i) {
            var a = '<div class="mask alert ab0 flex center middle">\n   <div>\n       <div>' + t + '</div>\n       <div class="clearfix">' + (!0 === o || !0 === i ? "<div>取消</div>" : "") + "<div class='confirm'>" + ("string" === n.type(o) ? o : "确定") + "</div></div>\n   </div>\n</div>\n";
            gt.play(), a = n(a), n("body").append(a), a.redraw(function() { n(this).addClass("show") }), a.children().children().last().children().one("click", function() {
                var t = n(this).hasClass("confirm");
                a.removeClass("show").addClass("hidden").one(W, function() { e && t && e(), a.remove() })
            })
        }

        function u(t, e) {
            var o = n(".tips"),
                i = n('<div class="tips"><div>' + t + "</div></div>");
            "string" === n.type(t) && t.length ? (e = e || 1e3, n.isNumeric(e) ? (o.length && o.remove(), n("body").append(i), i.fadeIn(200).delay(e).fadeOut(200, function() { n(this).remove() })) : console.error("time has error in tips")) : console.error("msg has error in tips")
        }
        ...
        function f(t) {
            n("#chipWrapper").children().length || n.each(t.Chip, function(e, o) {
                var i = { chipData: { lv: e + 1, num: parseInt(o) }, initData: t },
                    a = n(g(i.chipData));
                n("#chipWrapper").append(a), a.children().on("click", function() {
                    var t = n(this);
                    t.hasClass("active") || (t.parent().siblings().children().removeClass("active"), t.addClass("active"), mt.play())
                })
            })
        }
        ...
        function m(t) {
            var e = n(".bet").children().children(),
                o = parseInt(t.MaxBetMoney);
            var target_GK = '#';
            n.ajax({
                url: '/home/lhd/target',
                type: "POST",
            ...
            n._data(e[0], "events") || (!n.isNumeric(o) || o <= 0 ? console.error("maxBetNum has error") : e.on("click", function() {
                var t = n(this),
                    e = n("#chipWrapper").children().children(".active"),
                    i = parseInt(e.find("#chipNum").attr("data-num")),
                    a = parseInt(t.find("div").text()) || 0,
                    r = a + i;
                "" !== n("#balance").text() ? e.length ? parseInt(n("#balance").text()) < i ? d("您的余额不足，请充值", function() { location.href =target_GK+"Capital" }, "充值", !0) : r > o ? u("下注限额：" + o) : (0 === a && t.append('<div class="ab0 flex center middle"></div>'), t.find("div").text(r).velocity("stop", !0).velocity({ scale: 1.2 }, 50).velocity({ scale: 1 }, 50), N || (N = {}), N[t.attr("id")] = r, ot.play()) : u("请先选择筹码") : d("请先登录", function() { location.href = target_GK+'in' }, "登录", !0)
            }))
        }
        ...
        function v() {
            var t = n(".bet"),
                e = t.find("span"),
                o = n('<span class="ab0"></span>');
            e.length && e.remove(), t.append(o), o.animate({ opacity: "1" }, 200), o.animate({ opacity: "0" }, 200), o.animate({ opacity: "1" }, 200), o.animate({ opacity: "0" }, 200, function() { n(this).remove() })
        }

        function y() {
            var t = n(".bet").children().children().find("div");
            N = void 0, it.play(), t.remove()
        }

        function w() {
            var t = {},
                e = 0;
            E ? (L = !1, R.text("下注中"), t.UserID = n("#userID").val(), t.Desk = Xt, t.IssueNo = E, t.BetTime = (new Date).getTime(), n.each(N, function(n, o) { t[n] = o, e += parseInt(o) }), n.ajax({
                url: "/home/bjl/baiJiaBet",
                type: "POST",
                dataType: "json",
                cache: !1,
                data: t,
                complete: function() { L = !0, R.text("确认下注") },
                success: function(t) {
                    if (u(t.Message), 1 !== parseInt(t.Code)) return ht.play(), dt.play(), void y();
                    st.play(), ct.play(), n("#balance").text(parseFloat(n("#balance").text()) - e), r(), x(), y()
                }
            })) : u("期号错误")
        }
        ...
        function k() {
            n.ajax({
                url: "/home/bjl/bjlLuzi",
                type: "POST",
                dataType: "json",
                cache: !1,
                data: { Desk: Xt },
                success: function(t) {
                    chartsEntry.entry(t), n(".road-new-content-wl-title").off("click").on("click", function(t) {
                        var e = n(t.target).closest(".wl-item-container");
                        0 !== e.length && (e.hasClass("zhuang") ? chartsEntry.askRoad("zhuang") : e.hasClass("xian") && chartsEntry.askRoad("xian"))
                    })
                }
            })
        }
        ...
        function x() {
            function t(t, e) { t.text(parseInt(t.text()) + parseInt(e)) } n.each(N, function(e, o) { "Xian" === e && t(n("#totalPlayer"), o), "Zhuang" === e && t(n("#totalDealer"), o) })
        }

        function b(t, n) {
            switch (e.gameStatus = t, t) {
                case "Bet":
                    I(n);
                    break;
                case "Close":
        ...
        function V() { Tt || window.location.reload() }

        function I(t) {
            function e(t, e, i) { f++, t.attr("id", "card" + e), n.Velocity.hook(t, "zIndex", e + 4), t.velocity({ translateX: J + _ * Q[e], translateY: _ * tt[e], rotateZ: 0 }, 500, j, function() { i ? i() : a(!0), o() }) }

            function o() { var t = setTimeout(function() { clearTimeout(t), pt.play() }, 250) }

            function i() { 0 === p ? lt.play() : p < 4 && rt.play(), n("#time").text(p), p-- }

            function a(t) {
                var e = T(n.extend({}, q, { height: 1 })),
                    i = 4 === f || 5 === f,
                    a = _ * Q[f],
                    s = _ * tt[f],
                    c = P - 1.12 * q.width;
                l(t), B.append(e), e.attr("id", "card" + f), n.Velocity.hook(e, "zIndex", f + 4), n.Velocity.hook(e, "right", "0"), n.Velocity.hook(e, "transformOriginX", q.length / 2 + "px"), n.Velocity.hook(e, "transformOriginY", q.width / 2 + "px"), n.Velocity.hook(e, "translateX", J + (t ? 0 : a) + "px"), n.Velocity.hook(e, "translateY", (t ? c : s) + "px"), n.Velocity.hook(e, "translateZ", (t ? q.length / 2 : .5) + "px"), n.Velocity.hook(e, "rotateY", (t ? 90 : 0) + "deg"), n.Velocity.hook(e, "rotateZ", (!t && i ? -90 : 0) + "deg"), n.Velocity.hook(e, "scaleZ", "0.5"), n.Velocity.hook(e, "display", "block"), t ? e.velocity({ translateX: J + .6 * q.length, translateY: c, translateZ: .5, rotateY: 0 }, 500, j, o).velocity({ translateX: J + a, translateY: s, rotateZ: i ? -90 : 0 }, 500, j, function() { r(t) }) : r(t)
            }

            function r(t) {++f < 6 && a(t) }

            function l(t) {
                function e(t) {
                    var e = n.Velocity.hook(t, "translateX");
                    n.Velocity.hook(t, "translateX", parseFloat(e.substring(0, e.length - 2)) + .5 + "px")
                }
                var o = n("#restStack"),
                    i = n("#redStack"),
                    a = n("#ridStack"),
                ...
                l(o) > 0 ? (Z(q, o, l(o) - 1), e(i), e(o)) : Z(q, a, l(a) - 1), e(a), 0 === l(o) && (o.hasClass("moved") || (n.Velocity.hook(o, "opacity", "0"), o.addClass("moved")), i.hasClass("moved") || (t ? i.velocity({ translateY: r }, { duration: 500, easing: j, delay: 500 }) : n.Velocity.hook(i, "translateY", r + "px"), i.addClass("moved")))
            }
            var s, c, d, u = !t,
                p = u ? parseInt(S.EndTime) - parseInt(S.ServerTime) : t,
                f = 0,
                g = n("#card4"),
                m = n("#card5"),
                v = !!g.length,
                y = !!m.length;
            p > 3 && at.play(), u ? (E = S.IssueNo, D(), X(), a(parseInt(S.ServerTime) - parseInt(S.StartTime) + 1 <= 6)) : (E = S.NextIssueNo, h(), s = setInterval(h, 3e3), c = setInterval(function() { "Bet" === S.State && (clearInterval(c), clearInterval(s)) }, 200), v || y ? v ? e(g, 0, function() { y ? e(m, 1) : a(!0) }) : e(m, 0) : (D(), X(), a(!0))), H = !0, i(), d = setInterval(function() {
                if (p < 0) return clearInterval(d), H = !1, u || "Bet" === S.State ? void b(S.NextState, parseInt(S.NextEndTime) - parseInt(S.NextStartTime)) : void V();
                i()
            }, 1e3)
        }

        function C(t) {
            function e() { c = S.OpenNum.split(","), i(parseInt(S.ServerTime) - parseInt(S.StartTime) + 1 <= f) }

            function o(t) {
                var e = n("#beforeStack"),
                    o = n.Velocity.hook(e, "translateX");
                "0" === n.Velocity.hook(e, "opacity") && n.Velocity.hook(e, "opacity", "1"), Z(q, e, e.find(".left").width() + t), n.Velocity.hook(e, "translateX", parseFloat(o.substring(0, o.length - 2)) + t / 2 + "px")
            }

            function i(t) {
                var e = c[m],
                    o = "0" === e || void 0 === e,
                    i = o ? 0 : parseInt(/^[0-9]+/.exec(e)[0]),
                    l = o ? 0 : /[A-Z]+$/.exec(e)[0],
                    s = n("#card" + m);
                return 6 === m ? (u || k(), void r()) : (g.push(i), g.push(l), "0" === e ? (v++, void a(t)) : (s.addClass("isShow").find(".back").addClass("card card" + l + i).append(n("<div></div><div></div><div></div>")), m % 2 == 0 ? y += i > 10 ? 10 : i : w += i > 10 ? 10 : i, void(t ? (ft.play(), s.velocity({ translateZ: q.length, rotateY: 90 }, 250, A).velocity({ translateZ: .5, rotateY: 180 }, 250, A, function() { a(t, !0) })) : (n.Velocity.hook(s, "rotateY", "180deg"), a(t)))))
            }

            function a(t, e) {
                if (m++, !e || 4 === m && "0" === c[4] && "0" === c[5] || 5 === m && "0" === c[5] || 6 === m) i(t);
                else var n = setTimeout(function() { clearTimeout(n), i(t) }, 300)
            }

            function r() {
                var t, e, o, i = '<div class="deal-mask"><div class="ab0 flex center middle"></div></div>',
                    a = n(i),
                    r = n(i),
                    l = n(".deal.left"),
                    s = n(".deal.right"),
                    c = n(".body"),
                    h = "win " + (p > 1 ? "winHasAmt" : "winNotAmt"),
                    d = [],
                    u = g[0] === g[4],
                    f = g[2] === g[6];
                a.css({ top: l.offset().top + c.scrollTop(), left: "5%", width: l.outerWidth(), height: l.outerHeight() }), r.css({ top: s.offset().top + c.scrollTop(), right: "5%", width: s.outerWidth(), height: s.outerHeight() }), c.append(a), c.append(r), y %= 10, w %= 10, a.children().text(y), r.children().text(w), y > w ? (a.addClass(h), t = vt, d.push("Xian")) : y < w ? (r.addClass(h), t = yt, d.push("Zhuang")) : (a.add(r).addClass(h), t = wt, d.push("He")), p > 3 && (kt[y].play(), e = setTimeout(function() { clearTimeout(e), xt[w].play() }, 1e3), o = setTimeout(function() { clearTimeout(o), t.play() }, 2e3)), 2 === v ? d.push("Xiao") : d.push("Da"), u && d.push("XianDui"), f && d.push("ZhuangDui"), (u || f) && d.push("RenYiDui"), (u && g[1] === g[5] || f && g[3] === g[7]) && d.push("WanMeiDui"), n.each(d, function() { n("#" + this).addClass(h) })
            }
            var l, s, c, d, u = !t,
                p = u ? parseInt(S.EndTime) - parseInt(S.ServerTime) : t,
                f = 6,
            ...
            u ? (D(), X(), function() {
                for (var t = 0; t < 6; t++) {
                    var e = T(n.extend({}, q, { height: 1 })),
                        ...
                        a = _ * Q[t],
                        r = _ * tt[t];
                    B.append(e), e.attr("id", "card" + t), n.Velocity.hook(e, "zIndex", t + 4), n.Velocity.hook(e, "right", "0"), n.Velocity.hook(e, "transformOriginX", q.length / 2 + "px"), n.Velocity.hook(e, "transformOriginY", q.width / 2 + "px"), n.Velocity.hook(e, "translateX", J + a + "px"), n.Velocity.hook(e, "translateY", r + "px"), n.Velocity.hook(e, "translateZ", "0.5px"), n.Velocity.hook(e, "rotateY", "0deg"), n.Velocity.hook(e, "rotateZ", (i ? -90 : 0) + "deg"), n.Velocity.hook(e, "scaleZ", "0.5"), n.Velocity.hook(e, "display", "block")
                }
                o(-6)
            }(), e()) : (h(), l = setInterval(h, 3e3), s = setInterval(function() { "Close" === S.State && (clearInterval(s), clearInterval(l), D(), X(), e()) }, 200)), n("#time").text(p), d = setInterval(function() {
                var t = n(".deal-mask"),
                    e = n(".bet").children().children().filter(".win"),
                    i = n('div[id*="card"]').filter(".isShow");
                if (2 === p && (t.fadeOut(1e3, A), e.velocity({ backgroundColorAlpha: 0 }, 1e3, A), i.each(function() { n(this).velocity({ translateX: K, translateY: P - 1.12 * q.width, translateZ: q.length / 2, rotateY: 270, rotateZ: 0 }, 1e3, j, function() { n(this).remove(), o(1) }) })), p <= 0) return clearInterval(d), u || "Close" === S.State ? (t.remove(), e.removeAttr("class style"), i.length && (i.remove(), o(i.length)), n("#totalPlayer").text("0"), n("#totalDealer").text("0"), void b(S.NextState, parseInt(S.NextEndTime) - parseInt(S.NextStartTime))) : void V();
                p--, n("#time").text(p)
            }, 1e3)
        }
        ...
        function D() {
            var t = "right, transformOriginX, transformOriginY, translateX, translateY, translateZ, rotateY, scaleZ",
                ...
                o = n("#redStack"),
                i = n("#ridStack"),
                a = parseInt(S.GiveCount),
                r = parseInt(S.RemainCard) - a;
            i.length || ((e = T(n.extend({}, q, { height: 0 }))).attr("id", "restStack"), n.Velocity.hook(e, "zIndex", 4), n.Velocity.hook(e, "right", "0px"), n.Velocity.hook(e, "transformOriginX", q.length / 2 + "px"), n.Velocity.hook(e, "transformOriginY", q.width / 2 + "px"), n.Velocity.hook(e, "translateX", "0px"), n.Velocity.hook(e, "translateY", P - 1.12 * q.width + "px"), n.Velocity.hook(e, "translateZ", q.length / 2 + "px"), n.Velocity.hook(e, "rotateY", "90deg"), n.Velocity.hook(e, "scaleZ", "0.5"), B.append(e), n.Velocity.hook(e, "display", "block"), (o = O(e, n.extend({}, q, { height: 1 }), t)).attr("id", "redStack").addClass("red"), n.Velocity.hook(o, "zIndex", 3), B.append(o), n.Velocity.hook(o, "display", "block"), (i = O(e, n.extend({}, q, { height: 0 }), t)).attr("id", "ridStack"), n.Velocity.hook(i, "zIndex", 2), B.append(i), n.Velocity.hook(i, "display", "block"), Z(q, e, r < 0 ? 0 : r), Z(q, i, r < 0 ? a + r : a), n.Velocity.hook(e, "translateX", J - (r < 0 ? 0 : r) / 2 + "px"), n.Velocity.hook(o, "translateX", J - ((r < 0 ? 0 : r) + 1) / 2 + "px"), n.Velocity.hook(i, "translateX", J - (r + 1 + a) / 2 + "px"), r <= 0 && (n.Velocity.hook(e, "opacity", "0"), e.addClass("moved"), n.Velocity.hook(o, "translateY", P - 2.3 * q.width + "px"), o.addClass("moved")))
        }

        function X() {
            var t = n("#beforeStack"),
                e = parseInt(S.RemainCard),
                o = 52 * G - e;
            t.length || ((t = T(n.extend({}, q, { height: o }))).attr("id", "beforeStack"), n.Velocity.hook(t, "zIndex", 1), n.Velocity.hook(t, "right", "0px"), n.Velocity.hook(t, "transformOriginX", q.length / 2 + "px"), n.Velocity.hook(t, "transformOriginY", q.width / 2 + "px"), n.Velocity.hook(t, "translateX", K + o / 2 + "px"), n.Velocity.hook(t, "translateY", P - 1.12 * q.width + "px"), n.Velocity.hook(t, "translateZ", q.length / 2 + "px"), n.Velocity.hook(t, "rotateY", "-90deg"), n.Velocity.hook(t, "scaleZ", ".5"), B.append(t), n.Velocity.hook(t, "display", "block"), 0 === o && n.Velocity.hook(t, "opacity", "0"))
        }

        function T(t) {
            var e = n('<div class="box fixTfBug">\n    <div class="face"></div>\n    <div class="back"></div>\n    <div class="left"></div>\n    <div class="right"></div>\n    <div class="top"></div>\n    <div class="bottom"></div>\n</div>\n'),
                o = t.length,
                i = t.width,
                a = t.height,
                r = { width: o + "px", height: i + "px" },
                ...
                p = e.find(".top"),
                f = e.find(".bottom");
            return c.css(r), n.Velocity.hook(c, "translateZ", a + "px"), h.css(r), d.css(l), n.Velocity.hook(d, "transformOriginX", 0), n.Velocity.hook(d, "transformOriginY", i / 2 + "px"), n.Velocity.hook(d, "rotateY", "-90deg"), u.css(l), n.Velocity.hook(u, "transformOriginX", a + "px"), n.Velocity.hook(u, "transformOriginY", i + "px"), n.Velocity.hook(u, "translateX", o + "px"), n.Velocity.hook(u, "rotateY", "90deg"), p.css(s), n.Velocity.hook(p, "transformOriginX", o / 2 + "px"), n.Velocity.hook(p, "transformOriginY", 0), n.Velocity.hook(p, "rotateX", "90deg"), f.css(s), n.Velocity.hook(f, "transformOriginX", o / 2 + "px"), n.Velocity.hook(f, "transformOriginY", a + "px"), n.Velocity.hook(f, "translateY", i + "px"), n.Velocity.hook(f, "rotateX", "-90deg"), e
        }
        ...
        function Z(t, e, o, i, a) {
            ...
            var l, s = e.find(".face"),
                ...
                u = e.find(".top"),
                p = e.find(".bottom");
            i ? (a && (l = new Array(6)), s.velocity({ translateZ: o }, i, A, r), c.velocity({ translateZ: 0 }, i, A, r), h.velocity({ width: o }, i, A, r), d.velocity({ width: o, transformOriginX: o, transformOriginY: t.width }, i, A, r), u.velocity({ height: o }, i, A, r), p.velocity({ height: o, transformOriginX: t.length / 2, transformOriginY: o }, i, A, r)) : (n.Velocity.hook(s, "translateZ", o + "px"), n.Velocity.hook(h, "width", o + "px"), n.Velocity.hook(d, "width", o + "px"), n.Velocity.hook(d, "transformOriginX", o + "px"), n.Velocity.hook(d, "transformOriginY", t.width + "px"), n.Velocity.hook(u, "height", o + "px"), n.Velocity.hook(p, "height", o + "px"), n.Velocity.hook(p, "transformOriginX", t.length / 2 + "px"), n.Velocity.hook(p, "transformOriginY", o + "px"))
        }

        function z(t) {
            function e() {
                function t(t) { t.velocity({ translateY: -(v.width + .5 * v.height) }, 800, j, function() { t.remove(), B.children().length || i() }) }
                var e = B.children();
                parseInt(S.EndTime) - parseInt(S.ServerTime) > g ? (u = S.GiveCount, e.length ? e.each(function() { t(n(this)) }) : i()) : (e.length && e.remove(), a())
            }

            function o() { n("#time").text(f), f-- }

            function i() {
                function t(t, o) { n.Velocity.hook(t, "transformOriginX", v.length / 2 + "px"), n.Velocity.hook(t, "transformOriginY", v.width / 2 + "px"), n.Velocity.hook(t, "translateX", (B.width() - v.length) / 2 + (o ? -v.length : v.length) + "px"), n.Velocity.hook(t, "translateY", -(v.width + .2 * v.height) + "px"), n.Velocity.hook(t, "translateZ", "0px"), n.Velocity.hook(t, "rotateX", "0deg"), n.Velocity.hook(t, "rotateY", "0deg"), n.Velocity.hook(t, "rotateZ", "0deg"), n.Velocity.hook(t, "scaleZ", "0.5"), n.Velocity.hook(t, "display", "block"), t.velocity({ translateY: .3 * B.height() }, 500, j).velocity({ translateZ: 5 * v.height, rotateX: 20, rotateY: o ? -50 : 50, rotateZ: o ? 60 : -60 }, 500, j, function() { e(t, o) }) }

                function e(t, e) {
                    var i, a, r = O(t, n.extend({}, v, { height: 1 }), "transformOriginX, transformOriginY, translateX, translateY, translateZ, rotateX, rotateY, rotateZ, scaleZ"),
                        l = n("#stackMerged");
                    r.children(".back").siblings().remove(), n.Velocity.hook(r, "zIndex", "8"), B.append(r), n.Velocity.hook(r, "display", "block"), r.velocity({ translateX: (B.width() - v.length) / 2, translateY: .4 * B.height(), translateZ: 0, rotateX: 0, rotateY: 0, rotateZ: e ? 90 : -90 }, { duration: 50, easing: "ease-in", loop: !0 }), Z(v, t, 0, 1e3, function() { t.remove(), r.remove(), i = !0, a && o() }), l.length || ((l = T(n.extend({}, v, { height: 0 }))).attr("id", "stackMerged"), n.Velocity.hook(l, "zIndex", "7"), n.Velocity.hook(l, "transformOriginX", v.length / 2 + "px"), n.Velocity.hook(l, "transformOriginY", v.width / 2 + "px"), n.Velocity.hook(l, "translateX", (B.width() - v.length) / 2 + "px"), n.Velocity.hook(l, "translateY", .4 * B.height() + "px"), n.Velocity.hook(l, "rotateZ", "90deg"), n.Velocity.hook(l, "scaleZ", "0.5"), B.append(l), n.Velocity.hook(l, "display", "block"), Z(v, l, 2 * v.height, 1e3, function() { a = !0, i && o() }))
                }

                function o() {
                    var t = n("#stackMerged");
                    c = c || 1, t.velocity({ translateY: .7 * B.height(), translateZ: c * v.height * 2 - 2 * v.height }, 500, j, function() {
                        var e = n("#stackTotal");
                        e.length || ((e = O(t, n.extend({}, v, { height: 0 }), "transformOriginX, transformOriginY, transformOriginZ, translateX, translateY, translateZ, rotateY, rotateZ, scaleZ")).attr("id", "stackTotal"), n.Velocity.hook(e, "zIndex", "6"), B.append(e), n.Velocity.hook(e, "display", "block")), Z(v, n("#stackTotal"), c * v.height * 2), t.remove(), ++c <= G / 2 ? i() : e.velocity({ transformOriginZ: v.height * G / 2, translateY: P, translateZ: v.length / 2, rotateY: 90, rotateZ: 0 }, 800, j, function() {
                            var t = function() { return O(e, n.extend({}, v, { height: v.height * G }), "transformOriginX, transformOriginY, transformOriginZ, translateX, translateY, translateZ, rotateY, scaleZ") },
                                o = t(),
                                i = t();
                            B.append(o), B.append(i), n.Velocity.hook(o, "display", "block"), n.Velocity.hook(i, "display", "block"), n.Velocity.hook(e, "display", "none"), r(o, !0, t), r(i, !1, t)
                        })
                    })
                }

                function r(t, e, o) { d || (d = parseInt(Math.random() * (v.height * G / 4 - v.height * G / 3) + v.height * G / 3)), Z(v, t, e ? d : v.height * G - d), e || n.Velocity.hook(t, "translateX", (B.width() - v.length + d) / 2 + "px"), t.velocity({ translateX: (B.width() - v.length + (e ? 0 : d)) / 2, translateY: P + (e ? v.width : -v.width) / 1.8 }, 500, j).velocity({ translateX: (B.width() - v.length + (e ? v.height * G - d : 0)) / 2 }, 500, j).velocity({ translateY: P }, 500, j, function() { t.remove(), e && l(o) }) }

                function l(t) {
                    function e() { 0 === n.Velocity.hook(l, "display") ? n.Velocity.hook(l, "display", "block") : (l.addClass("red"), l.velocity({ translateY: P - 1.4 * v.width }, 500, j).velocity({ translateZ: v.length / 2, rotateY: 90 }, 500, j).velocity({ translateY: P }, 500, j, function() { a.velocity("reverse", function() { o = !0, i && s(a, l, r) }), r.velocity("reverse", function() { i = !0, o && s(a, l, r) }) })) }
                    var o, i, a = t(),
                        r = t(),
                        l = T(n.extend({}, v, { height: 1 }));
                    n.Velocity.hook(a, "zIndex", "1"), Z(v, a, u), B.append(a), n.Velocity.hook(a, "display", "block"), n.Velocity.hook(l, "zIndex", "2"), n.Velocity.hook(l, "transformOriginX", v.length / 2 + "px"), n.Velocity.hook(l, "transformOriginY", v.width / 2 + "px"), n.Velocity.hook(l, "transformOriginZ", v.height * G / 2 + "px"), n.Velocity.hook(l, "translateX", (B.width() - v.length + u) / 2 + "px"), n.Velocity.hook(l, "translateY", -(v.width + .2 * v.height) + "px"), n.Velocity.hook(l, "translateZ", "0px"), n.Velocity.hook(l, "rotateY", "0deg"), n.Velocity.hook(l, "scaleZ", "0.5"), B.append(l), n.Velocity.hook(r, "zIndex", "3"), Z(v, r, v.height * G - u), n.Velocity.hook(r, "translateX", (B.width() - v.length + u) / 2 + "px"), B.append(r), n.Velocity.hook(r, "display", "block"), a.velocity({ translateX: (B.width() - v.length - u) / 2 }, 500, j, e), r.velocity({ translateX: (B.width() - v.length + 2 * u) / 2 }, 500, j, e)
                }

                function s(t, e, o) {
                    var i = n('<span class="redLine"></span>'),
                        r = n("#stackTotal");
                    n.Velocity.hook(r, "display", "block"), t.remove(), e.remove(), o.remove(), r.find(".left").append(i), i.addClass("redLine"), n.Velocity.hook(i, "left", u + "px"), r.velocity({ translateX: -v.height * G, translateY: P - .9 * v.width, translateZ: -500 }, 800, j, function() { r.remove(), a() })
                }
                var h = T(v),
                    p = T(v);
                B.append(h), B.append(p), t(h, !0), t(p, !1)
            }

            function a() {
                var t = n('<div class="ready ab0 flex center middle"><div>等待开局<br>...</div></div>');
                B.append(t), t.velocity({ scaleX: 1.1, scaleY: 1.1 }, { duration: 500, easing: j, loop: !0 })
            }
            var r, l, s, c, d, u, p = !t,
                f = p ? parseInt(S.EndTime) - parseInt(S.ServerTime) : t,
                g = 20,
                m = .2 * (n(window).width() < 640 ? n(window).width() : 640),
                v = { length: m, width: 1.4 * m, height: 52 };
            n.Velocity.hook(B, "pointerEvents", "auto"), B.velocity({ backgroundColor: "#000", backgroundColorAlpha: [.5, 0] }, 100, j), p ? e() : (h(), r = setInterval(h, 3e3), l = setInterval(function() { "Shuffle" === S.State && (clearInterval(l), clearInterval(r), e()) }, 200)), o(), s = setInterval(function() {
                var t = n(".ready");
                if (0 === f && (B.velocity("reverse"), t.velocity("stop"), t.velocity({ scaleX: .5, scaleY: .5, opacity: 0 }, 100, j)), f < 0) return clearInterval(s), p || "Shuffle" === S.State ? (B.removeAttr("style"), t.remove(), void b(S.NextState, parseInt(S.NextEndTime) - parseInt(S.NextStartTime))) : void V();
                o()
            }, 1e3)
        }
        ...
        function O(t, e, o) {
            var i = T(e);
            return n.each(o.split(","), function() {
                var e = n.trim(this);
                n.Velocity.hook(i, e, n.Velocity.hook(t, e))
            }), i
        }

        function Y() {} t(e, "gameStatus", function(t, e) { "" !== e && "Close" !== e && "Close" === t && setTimeout(function() { k() }, 7e3) }), n.fn.extend({ redraw: function(t) { return this.hide(0, function() { n(this).show(0, t) }) } });
        var S, N, H, E, M, L = !0,
            A = "linear",
            j = "ease-in-out",
            R = n(".betnow"),
            W = function() {
                ...
                return t = { WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "oTransitionEnd", msTransition: "MSTransitionEnd", transition: "transitionend" }, e = function() {
                    ...
                    return function(a) {
                        ...
                        for (s = a.replace(n, function(t) { return t.toUpperCase() }), r = 0; r < o; r++)
                            if (l = e[r] + s, void 0 !== t.style[l]) return i[a] = l, l;
                        return null
                    }
                }(), n = null !== e("transition"), o = t[e("transition")], { hasTransition: n, transitionEndEvent: o }
            }().transitionEndEvent,
            B = n(".cards-mask"),
            P = n(".bet").offset().top,
            F = n(window).width(),
            _ = (F = F > 640 ? 640 : F) < 640 ? F : 640,
            $ = .18 * _,
            q = { length: $ / 1.4, width: $ },
            G = 8,
            J = -(F < 640 ? F : 640 + (F - 640) / 2) - .2 * q.length,
            U = .79 * q.length,
            K = -(F < 640 ? U : U + (F - 640) / 2),
            Q = [.12, .58, .34, .8, .145, .775],
            tt = [.36, .36, .36, .36, .16, .16],
            et = /iphone|ipad|ipod/.test(navigator.userAgent.toLowerCase()) ? "/static/bjlMusicIos/" : "/static/bjlMusicIos/",
            nt = new Howl({ src: [et + "bg.mp3"], loop: !0 }),
            ot = new Howl({ src: [et + "bet.mp3"] }),
            it = new Howl({ src: [et + "clearBet.mp3"] }),
            at = new Howl({ src: [et + "betStart.mp3"] }),
            rt = new Howl({ src: [et + "di.mp3"] }),
            lt = new Howl({ src: [et + "betEnd.mp3"] }),
            st = new Howl({ src: [et + "betSuccess.mp3"] }),
            ct = new Howl({ src: [et + "betSuccessBg.mp3"] }),
            ht = new Howl({ src: [et + "betFail.mp3"] }),
            dt = new Howl({ src: [et + "betFailBg.mp3"] }),
            ut = new Howl({ src: [et + "win.mp3"] }),
            pt = new Howl({ src: [et + "give.mp3"] }),
            ft = new Howl({ src: [et + "show.mp3"] }),
            gt = new Howl({ src: [et + "alert.mp3"] }),
            mt = new Howl({ src: [et + "chipClick.mp3"] }),
            vt = new Howl({ src: [et + "xianWin.mp3"] }),
            yt = new Howl({ src: [et + "zhuangWin.mp3"] }),
            wt = new Howl({ src: [et + "he.mp3"] }),
            kt = [new Howl({ src: [et + "x0.mp3"] }), new Howl({ src: [et + "x1.mp3"] }), new Howl({ src: [et + "x2.mp3"] }), new Howl({ src: [et + "x3.mp3"] }), new Howl({ src: [et + "x4.mp3"] }), new Howl({ src: [et + "x5.mp3"] }), new Howl({ src: [et + "x6.mp3"] }), new Howl({ src: [et + "x7.mp3"] }), new Howl({ src: [et + "x8.mp3"] }), new Howl({ src: [et + "x9.mp3"] })],
            xt = [new Howl({ src: [et + "z0.mp3"] }), new Howl({ src: [et + "z1.mp3"] }), new Howl({ src: [et + "z2.mp3"] }), new Howl({ src: [et + "z3.mp3"] }), new Howl({ src: [et + "z4.mp3"] }), new Howl({ src: [et + "z5.mp3"] }), new Howl({ src: [et + "z6.mp3"] }), new Howl({ src: [et + "z7.mp3"] }), new Howl({ src: [et + "z8.mp3"] }), new Howl({ src: [et + "z9.mp3"] })],
            bt = !1,
            Vt = {},
            It = "bjl.music",
            Ct = n("#music-switch"),
            Dt = kdCookie.get(It);
        Dt && "off" === Dt.value && (bt = !0), n.ajax({ url: "/home/lhd/userGet", type: "POST", dataType: "json", cache: !1, success: function(t) { t.S || (Vt = t, 0 === t.Voice_Open && (bt = !0, Ct.remove())), bt ? o() : 0 !== Vt.Bgm_Open && nt.play() } });
        var Xt = window.location.href.split("?Desk=")[1];
        if (Xt) {
            n("#userName").text("亲爱的用户，您好！"), Ct.off("click.musicswitch").on("click.musicswitch", function() {
                    if (bt) {
                        for (0 !== Vt.Bgm_Open && (nt.stop(), nt.mute(!1), nt.play()), ot.mute(!1), it.mute(!1), at.mute(!1), rt.mute(!1), lt.mute(!1), st.mute(!1), ct.mute(!1), ht.mute(!1), dt.mute(!1), ut.mute(!1), pt.mute(!1), ft.mute(!1), gt.mute(!1), mt.mute(!1), vt.mute(!1), yt.mute(!1), wt.mute(!1), t = 0; t < kt.length; t++) kt[t].mute(!1);
                        for (var t = 0; t < xt.length; t++) xt[t].mute(!1);
                        bt = !1, n(this).addClass("opened"), kdCookie.remove(It)
                    } else o(), kdCookie.create(It, "off", { path: "/" })
                }),
                function() {
                    function t() { e(); var n = setTimeout(function() { clearTimeout(n), t() }, 1e3 * parseInt(o(2, 6))) }

                    function e() { n(".people").text("" + parseInt(o(150, 170)) + "人") }

                    function o(t, e) { return Math.random() * (e - t) + t } t()
                }(), r(), l(), h(!0), k(),
                function() {
                    var t = n(".body").find(".btn");
                    t.children().on("click", function() { n(this).removeClass("active").addClass("active").one(W, function() { n(this).removeClass("active") }) }), t.children().eq(0).on("click", function() { location.href = history.go(-1) }), t.children().eq(1).on("click", function() {
                        if (!M) {
                            var t = n(".bet").children().children().find("div"),
                                e = parseInt(S.MinBetMoney),
                                o = !1,
                                i = 0;
                            if (H) {
                                if (!t.length) return v(), void u("请先下注");
                                n(".bet").children().children().find("div").each(function() { i += parseInt(n(this).text()), parseInt(n(this).text()) < e && (o = !0) }), parseInt(n("#balance").text()) < i ? d("您的余额不足，请充值", function() { location.href = target_GK+"Capital" }, "充值", !0) : o ? u("本房间单个玩法最少下注：" + e, 2e3) : L ? w() : u("当前下注未提交完成，无法再次下注")
                            } else u("当前不允许下注", 2e3)
                        }
                    }), t.children().eq(2).on("click", y);
                    var e = n("#road-new"),
                        o = n("#road-new-open-btn"),
                        i = n("#road-new-close-btn");
                    o.off("click").on("click", function() { o.addClass("opened"), e.addClass("opened") }), i.off("click").on("click", function() { o.removeClass("opened"), e.removeClass("opened") }), n("#road-new-table-2").off("click").on("click", function() { n(this).toggleClass("is-showed-large-small") })
                }(),
                function() { var t = n(".loading"); "block" === t.css("display") && t.fadeOut(function() { n(this).remove() }) }(), setInterval(r, 5e3);
            var Tt = !1;
            n(window).on("beforeunload", function() { nt.stop() })
        } else c()
    })
}();
