...
! function() { "use strict";
    ...
    function e(e) { var n = '<div class="mask alert ab0 flex center middle">\n   <div>\n       <div>' + e + "</div>\n       <div class=\"clearfix\"><div class='confirm'>确定</div></div>\n   </div>\n</div>\n";
        ...
        function t() { g && clearInterval(g), a() }
        					//这里请求数据
        function a() { n.ajax("/home/bjl/bjlList", { type: "POST", dataType: "json", cache: !1, success: function(e) { e && (s(e), l()), "block" === x.css("display") && v(e), r(e ? 1e3 * (parseInt(e.NextTime) - parseInt(e.ServerTime)) : 1e3) } }) }
        ...
        function v(e) { e && !e.Data.length || (g = setInterval(function() { n(".room").each(function() { var i = n(this),
                        t = i.find("span"),
                        a = parseInt(t.text());
                    0 === a ? e && n.each(e.Data, function() { if (i.find(".desk").text() === this.DisplayName) { i.find("b").text(d(this.NextState)); var e = parseInt(this.NextEndTime) - parseInt(this.NextStartTime); return e >= 0 && t.text(e), !1 } }) : --a >= 0 && t.text(a) }) }, 1e3)) } var u = function(e) { return new Howl({ src: e, loop: !0 }) }(/iphone|ipad|ipod/.test(navigator.userAgent.toLowerCase()) ? "/static/bjlMusicIos/bg.mp3" : "/static/bjlMusicIos/bg.mp3"),
            f = !1,
            p = "lhd.music",
            m = n("#music-switch"),
            h = kdCookie.get(p),
        ...
        n(".explainBtn").on("click", function() { var e = n('<div class="explain ab0 flex center middle">\n   <div class="wrapper">\n       <div class="header">规则说明</div>\n       <div class="body" id=gamerule>\n       </div>\n       <div class="footer">我知道了</div>\n   </div>\n</div>\n');
            n.ajax("/home/bjl/gameRule", { type: "POST", data: "{g: 'longhu'}", contentType: "application/json", success: function(n) { e.find("#gamerule").html(n) } }), n(this).velocity({ scale: .9 }, 100, "ease-in-out", function() { n(this).velocity("reverse") }), n("body").append(e), e.velocity({ backgroundColor: ["#000", "transparent"], backgroundColorAlpha: [.5, 0] }, 200, "ease-in-out"), e.children().velocity({ scale: [1, 1.2], opacity: [1, .5] }, 200, "ease-in-out"), e.find(".footer").one("click", function() { e.velocity("reverse", function() { n(this).remove() }), e.children().velocity({ scale: .8, opacity: 0 }, 200, "ease-in-out") }) }), m.off("click.musicswitch").on("click.musicswitch", function() { f ? (u.mute(!1), f = !1, n(this).addClass("opened"), kdCookie.remove(p)) : (u.mute(!0), f = !0, n(this).removeClass("opened"), kdCookie.create(p, "off", { path: "/" })) }), n(".back").one("click", function() { location.href = history.go(-1) }), t(), n(window).on("beforeunload", function() { u.stop() }) }), $.fn.extend({ redraw: function(e) { return this.hide(0, function() { $(this).show(0, e) }) } }) }();
