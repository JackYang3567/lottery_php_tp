...
CREATE TABLE `new_relationship` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='普通用户代理表';
...
INSERT INTO `new_relationship` VALUES ('14', '41', '', '', '', '1');
INSERT INTO `new_relationship` VALUES ('15', '66', '1', '4', '', '1');
